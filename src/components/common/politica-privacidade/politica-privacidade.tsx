    ...
    <section className="mt-2">
      <div className="row">
        <div className="container">
          <h2 className="text-2xl mb-3 font-bold text-faiz-100">
          ...
          <ul className="flex flex-col ml-3 mb-2 leading-relaxed">
          ...
          <h3 className="text-xl mb-3 font-bold text-faiz-100">
            Compromisso do Usuário
          </h3>
          <p className="mb-2 leading-relaxed text-faiz-100">
            O usuário se compromete a fazer uso adequado dos conteúdos e da
            informação que a Faiz Produções oferece no site e com caráter enunciativo,
            mas não limitativo:
          </p>
          <ul>
            <li>
              <p className="text-faiz-100">
            ...
            <li>
              <p className="text-faiz-100">
                ...
                xenofóbica, pix bet365 ou azar, qualquer tipo de pornografia
            ...
            <li>
              <p className="text-faiz-100">
                ...
                (softwares) da Faiz Produções, de seus fornecedores ou terceiros, para
          ...
          <h3 className="font-bold text-faiz-300 mt-3">Mais informações</h3>
          <p className="mb-2 leading-relaxed text-faiz-100">
